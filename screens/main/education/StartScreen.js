    ...
    this.state = {
      ...
      educations: [
        
        {
          value: "WAEC",
          label: "WAEC",
          image: require("../../../assets/ondemand/waec.jpg"),
          navigation: "Education.Waec",
          borderColor: "#dce7f4",
        },
        {
          value: "JAMB",
          label: "JAMB",
          image: require("../../../assets/ondemand/jamb.jpg"),
          navigation: "Education.Jamb",
          borderColor: "#dce7f4",
        },
            ...
            ListHeaderComponent={() => (
              <>
                ...
                <View style={styles.playBetWrapper}>
                  <Text style={styles.playBet}>Select education body</Text>
                </View>
              </>
            )}
