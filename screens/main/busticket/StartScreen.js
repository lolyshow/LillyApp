    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          props.navigation.navigate("BusTicket.Search")
          // props.navigation.navigate("BusTicket.TicketDownload")
        }}
      >
        ...
        <View style={{ flex: 1, paddingHorizontal: 15 }}>
          <Text style={{ fontWeight: "bold", fontSize: 30, textAlign: "right", color: "#17375e" }}>{item.name}</Text>
          {/* <Text style={{ color: "#707070", fontSize: 15 }}>{item.state}</Text> */}
          {/* <Text style={{ fontWeight: "bold", fontSize: 18, color: "#17375e" }}>{currency} {item.price}</Text> */}
        </View>
      </TouchableOpacity>
    )
  }
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View style={styles.container}>
        <View style={styles.titleWrapper}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.title}>{'Transport Companies'}</Text>
          </View>
        </View>
        <View
          style={{
...
const companies = [
  {
    id: 1,
    image: require("../../../assets/network/chisco.png"),
    name: "Chisco",
