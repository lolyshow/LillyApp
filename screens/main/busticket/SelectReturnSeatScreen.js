...
export default function SelectReturnSeatScreen(props) {
  ...
  const getBusDetails = (params) => {
    ...
    for (let num = 1; num <= params.availableSeat.length; num++) {
      if (params.availableSeat.includes(num))
  ...
  const proceed = () => {
    ...
    let transportDetails = parameters;
    transportDetails.returningSeats = selectedSeats;
